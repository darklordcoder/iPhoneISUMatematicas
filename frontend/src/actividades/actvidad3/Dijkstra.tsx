...
// function findAllShortestPaths(graph: Graph, startNode: string) {
//     const { distances, previous } = dijkstra(graph, startNode);
//     const paths: { [key: string]: { distance: number, path: string[] } } = {};

//     Object.keys(distances).forEach(endNode => {
...
export const Dijkstra = () => {
    ...
    const [finalNode, setFinalNode] = useState(6);
